...
const EditGuardiaModal = ({ show, onClose, onEdit, guardia, isSaved, setIsSaved, isFailure, setIsFailure, message }) => {
                            ...
                            <Box sx={{ display: "grid", gap: 2 }}>
                                ...
                                {formData.ine && !showCameraModal && (
                                    <center><img
                                        ...
                                        alt="INE"
                                        style={{ marginTop: 10, width: isMobile ? "100%" : "60%", borderRadius: 8 }}
                                    /></center>
                                )}
                                {showCameraModal && (
                                    <CameraModal
